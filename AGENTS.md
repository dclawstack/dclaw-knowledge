...
**DClaw Knowledge** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8063` (FastAPI)
- **Frontend Port:** `3063` (Next.js)
- **Database:** `dclaw_knowledge` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3063`
